...
public class SwarovskiHomePageLocators {
    ...
    public static By clickOnWeddingGifts = By.cssSelector("a[rel='Wedding gifts']");
    public static By clickOnCategories = By.cssSelector("div[data-filter-id='category']>span[class='swa-filter-category-desktop__filter-name swa-label-sans--small swa-label-sans--small-strong']");
    ...
    public static By clickOnMaterialDropDown = By.cssSelector("div[data-filter-id='product_material']>span[class='swa-filter-category-desktop__filter-name swa-label-sans--small']");
